...
call dein#add("gregsexton/MatchTag") " tagの色づけ
...
call dein#add('Shougo/unite-outline') "outline
...
" リファレンス
"==================================================================================
call dein#add('thinca/vim-ref') " マニュアル確認できる
call dein#add('mojako/ref-sources.vim') "refに別のマニュアルを追加
call dein#add('mustardamus/jqapi') " jQueryのマニュアル
call dein#add('tokuhirom/jsref') " JSのマニュアル
...
" diff
"==================================================================================
call dein#add('lambdalisue/vim-unified-diff') " vimdiffのアルゴリズム変更
...
call dein#add('jiangmiao/simple-javascript-indenter') "javascriptのインデント
...
call dein#add('akiyan/vim-textobj-php') " phpタグ選択 vaP or viP

" PDV
call dein#add('PDV--phpDocumentor-for-Vim') " PHP用コメント挿入
